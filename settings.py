...
SECRET_KEY = 'django-insecure-7+*uia0)uzc-twx^55gsur7hpkueh*@v8rh6-)kj3va)&+n3he'
...
# For API views, you might want to disable CSRF for API endpoints
# OR handle CSRF tokens properly
